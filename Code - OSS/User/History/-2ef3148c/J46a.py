...
note_track.append(mido.Message('', channel=1, note=12, velocity=0, time=312))
note_track.append(mido.Message('', channel=1, note=21, velocity=0, time=312))
note_track.append(mido.Message('', channel=2, note=20, velocity=0, time=312))
note_track.append(mido.Message('', channel=1, note=3C, velocity=0, time=312))
