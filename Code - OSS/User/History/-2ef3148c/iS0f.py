...
# Register MOD(1)
note_track.append(mido.Message('note_on', channel=1, note=1, velocity=0, time=312))
note_track.append(mido.Message('note_on', channel=1, note=2, velocity=0, time=312))
note_track.append(mido.Message('note_on', channel=2, note=2, velocity=0, time=312))
note_track.append(mido.Message('note_on', channel=1, note=3, velocity=0, time=312))
